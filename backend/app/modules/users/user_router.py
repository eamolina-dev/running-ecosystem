...
from app.modules.users.user_schema import UserCreate, UserUpdate, UserRead
from app.modules.users import user_service
from app.core.deps import get_current_user
from app.modules.users.user_model import User
from app.modules.runners.runner_model import Runner
from app.modules.organizations.organization_model import Organization
from app.modules.users.user_service import format_user_with_profile
...
def update_user(user_id: int, user_in: UserUpdate, db: Session = Depends(get_db)):
    return user_service.update(db, user_id, user_in)
